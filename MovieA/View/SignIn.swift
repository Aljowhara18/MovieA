...
struct SignIn: View {
    ...
    // هذا المتغير يربطنا بملف الـ App لتبديل الواجهة بالكامل
    ...
    // MARK: - Body
    var body: some View {
        // حذفنا الـ NavigationStack لكي لا تصبح صفحة تسجيل الدخول جزءاً من مسار الرجوع
        ZStack {
            background
            ...
            VStack {
                ...
                SignInButton(
                    ...
                    action: {
                        guard isFormValid else { return }
                        // عند تسجيل الدخول، نغير الحالة ويقوم ملف الـ App بتبديل الواجهة
